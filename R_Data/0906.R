# 2차원 배열
x = 1:10
arr = array(x, dim=c(2, 5)) # 설정된 행 열의 개수로만 저장 공간이 제공된다.
arr
...
lst = append(lst1, lst1.gender, after=1)
lst1
