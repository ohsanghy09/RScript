...
# 행렬데이터를 데이터프레임으로 변환(미세먼지를 문자열에서 숫자 형태로)
...
map = st_read("C:/Users/AISW-509-189/Desktop/R_Data/map_datasets/Z_NGII_N3A_G0010000.shp", options = "ENCODING=EUC-KR")
map
